...
52 early Buddhist discourses in clear, common English, with newcomer guidance,
...
- Python 3.11 or 3.12
- Node.js 22 and pnpm 10 for rendered browser checks
...
Build and exercise the rendered reader after installing the browser dependency:
...
The repository has 52 registered translation surfaces and a plain-English
...
Picking the work up cold: start with [docs/translation-workflow-plan.md](docs/translation-workflow-plan.md), whose Start Here section lists what to read and in what order, followed by the current state and the open work.

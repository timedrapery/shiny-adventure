...
- [`wave-11-execution-plan.md`](wave-11-execution-plan.md): current queue, validation gates, and machine-independent handoff procedure
- [`wave-10-execution-plan.md`](wave-10-execution-plan.md) and [`wave-9-execution-plan.md`](wave-9-execution-plan.md): superseded records of completed waves, kept for their source findings
...
- [`wave-11-execution-plan.md`](wave-11-execution-plan.md): current executable plan and restart procedure

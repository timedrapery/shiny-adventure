...
- Keep `khandha` as `heap`.
- Keep `pañcakkhandhā` as `five heaps`.
- Keep `pañcupādānakkhandhā` as `five clung-to heaps`.
- Keep `sakkāya` as `identity` and read it through the five clung-to heaps.

...
- `aniccā sabbasaṅkhārā` -> `all that has been put together is impermanent`
  Keep `saṅkhārā` on its result-side reading here rather than the dependent-arising process sense.
- `dukkhā sabbasaṅkhārā` -> `all that has been put together is unsatisfactory`
...
- `yaṃ aniccaṃ taṃ dukkhaṃ; yaṃ dukkhaṃ tad anattā` -> `what is impermanent is dissatisfaction; what is dissatisfaction is not-self`

...
- Use Wave 3 in [next-suttas-roadmap.md](next-suttas-roadmap.md) for the next strategic expansion surfaces, continuing with `SN 46.51` after the completed `SN 36.6` surface.

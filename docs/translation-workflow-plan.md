...
- Use Wave 3 in [next-suttas-roadmap.md](next-suttas-roadmap.md) for the next strategic expansion surfaces, continuing with `MN 7` after the completed Wave 2 set.

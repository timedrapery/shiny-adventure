...
- Use Wave 3 in [next-suttas-roadmap.md](next-suttas-roadmap.md) for the next strategic expansion surfaces, continuing with `SN 36.6` after the completed `MN 7` surface.

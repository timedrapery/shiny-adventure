# MN 141: Saccavibhaṅga Sutta (Analysis of the Truths)

## Editorial Note

- This is a repo-native study translation of MN 141, designed to be readable
  as a single Markdown document.
- Companion translator notes:
  [MN 141 Translation Notes](mn141-saccavibhanga-sutta-notes.md)
- Source basis: the Pali text of MN 141 as segmented in SuttaCentral's Bilara
  data.
- House choices that most affect this sutta: `ariyasacca` is rendered `noble
...
- The first-truth definitions and the eightfold-path definitions are laid out
  ...
  system.
- This is the first stable study edition of the repository's MN 141
  translation surface.

# MN 10: Satipaṭṭhāna Sutta (Establishment of Sati)

## Editorial Note

- This is a repo-native study translation of MN 10, designed to be readable
  as a single Markdown document.
- Companion translator notes:
  [MN 10 Translation Notes](mn10-satipatthana-sutta-notes.md)
- Source basis: the Pali text of MN 10 as segmented in SuttaCentral's Bilara
  data.
...
- Repeated refrain material is laid out in full when the pattern first needs to
  be heard clearly, then compacted where later repetitions add no new policy.
- This is the first stable study edition of the repository's MN 10 translation
  surface.

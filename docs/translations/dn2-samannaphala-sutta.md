# DN 2: Sāmaññaphala Sutta (The Fruits of the Ascetic Life)

## Editorial Note

- This is a repo-native study translation of DN 2, designed to be readable as
  a single Markdown document.
- Companion translator notes:
  [DN 2 Translation Notes](dn2-samannaphala-sutta-notes.md)
...
- House choices that most affect this sutta: `sīla` is rendered `conduct`;
  ...
  rendered `ease` in the jhāna sequence; `abhiññā` is rendered `higher
  knowing`; and `āsava` is rendered `outflow`.
- This edition treats DN 2 as a control passage for the gradual-training
  sequence, the hindrance-clearing lead-in, the four mental themes, and the
  higher-knowledge close.
- This is the first stable study edition of the repository's DN 2 translation
  surface.

...
- This is a repo-native study translation of AN 4.113, designed to be
  readable as a single Markdown document.
- Companion translator notes:
  [AN 4.113 Translation Notes](an4-113-patoda-sutta-notes.md)
- Source basis: the Pali text of AN 4.113 as segmented in SuttaCentral's
  Bilara data.
- House choices that most affect this sutta: `saṁvega` is rendered `urgency`;
  `yoniso` is rendered `thoroughly` in the striving formula; `paññā` is
  rendered `discernment`; `kāya` is rendered `body`; and `vedanā` in the
  fourth type is rendered `felt experience`.
- This edition treats AN 4.113 as the repository's control surface for the
  urgency-and-striving formula and the four-thoroughbred analogy applied to
  spiritual development.
- This is the first stable study edition of the repository's AN 4.113

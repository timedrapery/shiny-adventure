...
- `ānāpānasati` remains untranslated in source-facing prose.
- When a gloss is needed, use `remembering the Dhamma while breathing in and
  out`.
- `sati` remains `remembering`; in this sutta it is not generic recollection
...
- This pass clarified the assembly's travel image and repaired the subject and
  ...
  factors, and the governed breathing and conditioner formulas.
